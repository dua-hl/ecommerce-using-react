...
export default function CreateAccount() {
  ...
  return (
    ...
    <h2 className='p-3 text-center'>Create an Account</h2>

    <input type="text" autoComplete='off' placeholder="Name" name="userName" value={formik.values.userName} onChange={formik.handleChange} />
...
{formik.touched.email && formik.errors.email ? (<p className={`fw-bold mt-3 ${style.frontError}`}>{formik.errors.email}</p>) : null}
    ...
    <input type="password" autoComplete='off' placeholder='Confirm password' name='cPassword' value={formik.values.cPassword} onChange={formik.handleChange}/>
